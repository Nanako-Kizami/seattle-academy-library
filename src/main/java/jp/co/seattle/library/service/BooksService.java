...
public class BooksService {
	...
	public int registBook(BookDetailsInfo bookInfo) {
		...
		String sql = "INSERT INTO books (title, author, publisher, publish_date, thumbnailName, thumbnailUrl, Isbn, description, reg_date, upd_date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, now(), now()) RETURNING id";
